...
<template>
  <div
    class="flex md:items-center md:px-28 flex-col md:flex-row py-16 space-y-10 px-6"
  >
    <div class="flex-1">
      <div
        class="mx-auto md:mx-0 border-4 border-cyan-500 shadow-lg shadow-cyan-300/40 overflow-hidden rounded-full w-96 h-96"
      >
        <slot> </slot>
      </div>
    ...
    <div
      class="flex-1 max-w-xl bg-gray-50 rounded-md shadow-lg shadow-cyan-300/50 max-w-96 p-8 border-2 border-cyan-500"
    >
